...
> Looking for the application this repo implements? See the
> [project README](../README.md) — **SST Auditor Agent Pro — Backend**.
...
- **Configured language** — all code, comments, docs, and commits use the active
  language set in `openspec/config.yaml` (`os-language <code>`)
