...
class SupervisedHooks(types_utils.ContractsLanguageDunderMixin):
    def __init__(self, *, pre_posting_hook: Optional[SupervisionExecutionMode] = None):
...
class SmartContractDescriptor(types_utils.ContractsLanguageDunderMixin):
    def __init__(
        self,
        *,
        alias: str,
        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring=f"""
                    ...
                    [SupervisedHooks]({_common_docs_path}classes/#SupervisedHooks)
