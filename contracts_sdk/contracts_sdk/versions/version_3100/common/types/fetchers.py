        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    effective time or the interval start time, or as a time defined in Vault Core.
                    If no end datetime is set or if it is set to `None`, this will default to
                    [DefinedDateTime](../types/#enums-DefinedDateTime).`LIVE`, which
                    will fetch data up to the hook's execution datetime. Note:
