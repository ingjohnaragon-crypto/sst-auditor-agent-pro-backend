        ...
        return types_utils.ClassSpec(
            ...
            docstring="""
                **Only available in version 3.3+.**
                ...
                [EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType)s
                included in its execution_schedules hook.
            """,
        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    of an
                    [EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType).
                    The tags must be created in the Scheduler before they are referenced in a Smart
                    Contract. Vault Core environments with the Multiple Processing Groups optional
                    Extension enforce this on Product Version creation. The tag IDs are global in Vault
                    and must exactly match the tag IDs created in the Scheduler.
                    [EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType)s in
                    different contracts with the same tag will be linked together. Defaults to no
                    tags if a tag ID is not provided.
                """,
            ),
        ]
