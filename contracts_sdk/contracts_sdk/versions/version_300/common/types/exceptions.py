    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ExceptionSpec(
            ...
            docstring=(
                ...
                "the [pre_parameter_change_code](../../smart_contracts_api_reference3xx/hooks/#pre_parameter_change_code) "
            ...
            constructor_args=[
                types_utils.ValueSpec(
                    ...
                    docstring=(
                        ...
                        "[PostingInstructionBatch](/api/core_api/#Posting_instruction_batches-PostingInstructionBatch) in the Core API."
                    ),
                ),
                types_utils.ValueSpec(
                    name="reason_code",
