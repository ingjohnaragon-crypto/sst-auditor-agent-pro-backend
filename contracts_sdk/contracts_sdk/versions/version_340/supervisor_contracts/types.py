    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            ...
            docstring=(
                ...
                "[EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType) "
                "associated with it. Each "
                "[EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType) "
                "must have a unique name within the Supervisor Contract and can have optional "
                "Scheduler Tags and overridden Schedules attributes. Each Supervisor Contract "
                "must include all "
                "[EventTypes](../../smart_contracts_api_reference3xx/types/#classes-EventType) "
                "returned by the "
        ...
        return [
            types_utils.ValueSpec(
                ...
                docstring="""
                    The name of the
                    [EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType).
                    This name will be the same as the name defined in the
                    [execution_schedules](../../smart_contracts_api_reference3xx/hooks/#execution_schedules)
                    hook.
                """,
            ),
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    [account schedule tags](/api/core_api/#Account_schedule_tags-AccountScheduleTag)
                    of an
                    [EventType](../../smart_contracts_api_reference3xx/types/#classes-EventType).
                    The tags must be created in the Scheduler before they are referenced in a
                    Supervisor Contract. Vault Core environments with the Multiple Processing Groups
                    Extension enforce this on Supervisor Contract Version creation. The tag
                    IDs are global in Vault and must exactly match the tag IDs created in the
                    Scheduler.
                    [EventTypes](../../smart_contracts_api_reference3xx/types/#classes-EventType)
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    A list of (Smart Contract `alias`, `event_type`) tuples specifying which are the
                    overridden Schedules for each
                    [EventType](../../supervisor_contracts_api_reference3xx/types/#classes-EventType).
                    If not provided, this
                    [EventType](../../supervisor_contracts_api_reference3xx/types/#classes-EventType)
                    does not override any of the Supervisee Schedules. The Smart Contract alias is
                    the alias defined in the
                    [SmartContractDescriptor](../../supervisor_contracts_api_reference3xx/types/#classes-SmartContractDescriptor).
                    Note that each Supervisor EventType can only override one Schedule per
                    Supervisee. If multiple Supervisee Schedules need to be overridden, this has to
