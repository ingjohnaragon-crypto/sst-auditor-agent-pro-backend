...
def validate_datetime_is_timezone_aware(datetime: datetime, field_path: str, class_type: str):
...
def validate_datetime_has_given_timezone(
    ...
    validate_datetime_is_timezone_aware(datetime, field_path, class_type)
