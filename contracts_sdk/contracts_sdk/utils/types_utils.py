...
def verify_public_methods_have_abstract_methods(
    ...
    inheritance tree with an associated abstract method for that function.
    """
...
class NativeObjectSpec:
    ...
    def __init__(
        ...
        *,
        ...
        self.inline_import_example = inline_import_example
...
class DecoratorSpec:
    ...
    def __init__(
        ...
        *,
        ...
        docstring="",
        args=None,
        smart_contract_args: Optional[list[ValueSpec]] = None,
        supervisor_args: Optional[list[ValueSpec]] = None,
