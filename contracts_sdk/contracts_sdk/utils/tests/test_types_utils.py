...
class PublicTypeValidationHelpersTest(unittest.TestCase):
    ...
    def test_validate_type_check_empty_and_optional_raises_for_empty_str(self):
        item = ""
        with self.assertRaises(exceptions.InvalidSmartContractError) as ex:
            types_utils.validate_type(item, str, check_empty=True, is_optional=True)
        self.assertEqual("Expected non-empty string if populated", str(ex.exception))

    def test_validate_type_check_empty_and_optional_raises_for_empty_str_with_prefix(self):
        item = ""
        with self.assertRaises(exceptions.InvalidSmartContractError) as ex:
            types_utils.validate_type(
                item, str, check_empty=True, is_optional=True, prefix="Prefix"
            )
        self.assertEqual("'Prefix' must be a non-empty string if populated", str(ex.exception))
...
class ContractsLanguageDunderMixinTests(unittest.TestCase):
    ...
    def test_unequal_a(self):
        ...
        self.assertNotEqual(obj, other_obj)
